...
import { Code, BarChart3, Clock, Users, Trophy, Eye, EyeOff, User, Settings, Home, FileText, BookOpen } from 'lucide-react';
                    ...
                    <table className="min-w-full divide-y divide-gray-700">
                        <thead className="bg-gradient-to-r from-blue-600 to-cyan-600">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-left text-xs font-semibold text-white uppercase tracking-wider">Problem</th>
                                <th className="px-6 py-3 text-left text-xs font-semibold text-white uppercase tracking-wider">Difficulty</th>
                        ...
                        <tbody className="divide-y divide-gray-700">
                            {recentProblems.map((problem) => (
                                <tr key={problem.id}>
                                    <td className="px-6 py-4 whitespace-nowrap text-gray-400">{problem.id}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-white font-medium">{problem.name}</td>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-gray-400">{problem.time}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-gray-400">{problem.date}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
            ...
            <div className="min-h-[91.1vh] bg-gradient-to-b from-[#0a0a12] to-[#2a2a4a] flex">
                ...
                <div className="flex-1 overflow-y-auto p-8">
                    {activeTab === 'profile' ? renderProfileTab() : 
                     ...
                     <div className="space-y-8 w-full">
                        <h1 className="text-3xl font-bold text-white">{sidebarItems.find(item => item.id === activeTab)?.label}</h1>
