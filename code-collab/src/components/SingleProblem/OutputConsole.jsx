...
const OutputConsole = ({ output, isRunning, onClearOutput }) => {
  ...
  return (
    <div className={`h-full ${theme.bg.secondary} flex flex-col`}>
      ...
      <div
        className={`${theme.bg.tertiary} p-2 border-b ${theme.border.primary} flex items-center justify-between shadow-sm`}
      >
      ...
      {/* Tab Content */}
      <div className="flex-1 bg-slate-900 border-t border-slate-700 overflow-hidden">
            ...
            <div className="h-full">
              {output ? (
                <div className="space-y-4">
                  {/* Main Output */}
                  {mainOutput && (
                    <div className="bg-slate-700 rounded-lg p-3 border border-slate-500 mb-3 shadow-lg">
                      ...
                      <div className="bg-slate-800 rounded p-2 border border-slate-600 max-h-24 overflow-y-auto">
                        <pre className="font-mono text-xs text-gray-100 whitespace-pre-wrap leading-snug">
                          {mainOutput}
                        </pre>
                      </div>
                    </div>
                  ...
                  {testResults && (
                    ...
                    >
                      ...
                      <div className="bg-slate-800 rounded p-2 border border-slate-600 max-h-32 overflow-y-auto">
                        <pre
              ...
              <div className="text-sm text-gray-400">
                <div className="mb-4">
                  ...
                  <div className="bg-slate-700 rounded p-3 space-y-2">
                    ...
                    <div>
                      • Memory usage:{" "}
                      <span className="text-blue-400">12.5 MB</span>
                    </div>
                    <div>
                      • Execution time:{" "}
                      <span className="text-yellow-400">0.023s</span>
                    </div>
                    <div>
                      • Test cases passed:{" "}
