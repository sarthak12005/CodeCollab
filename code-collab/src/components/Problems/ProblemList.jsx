                        ...
                        <div className="flex items-start justify-between">
                            <div className="flex-1">
                                ...
                                <div className="flex items-center space-x-4 mb-3">
                                    <span className={`inline-flex items-center px-2 py-1 rounded text-xs font-medium ${problem.difficulty === 'Easy' ? 'bg-green-500' :
                                    ...
                                    <div className="flex items-center space-x-2">
                                        {problem.tags.map((tag, index) => (
                                            <span key={index} className="text-xs text-gray-400 bg-slate-700 px-2 py-1 rounded">
                                                {tag}
                                            </span>
                                        ))}
                                    </div>
                            ...
                            <div className="ml-4 flex items-start space-x-2">
                                <button className="p-2 hover:bg-slate-700 rounded transition-colors">
                                    <Star className={`w-4 h-4 ${problem.isFavorited ? 'text-yellow-400 fill-current' : 'text-gray-400'}`} />
                                </button>
                            </div>
                        </div>
                    </div>
...
>>>>>>> e9e65871254b94363a4b5f61d069c2edfd01c1c1
        </div>
